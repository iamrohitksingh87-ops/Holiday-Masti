                    ...
                    <a
                        ...
                        <span class="whatsapp-icon">
                            <svg viewBox="0 0 32 32" aria-hidden="true">
                             <path d="M19.11 17.39c-.27-.14-1.59-.78-1.84-.87-.25-.09-.43-.14-.61.14-.18.27-.7.87-.86 1.05-.16.18-.32.2-.59.07-.27-.14-1.14-.42-2.17-1.34-.8-.71-1.34-1.59-1.5-1.86-.16-.27-.02-.42.12-.56.12-.12.27-.32.41-.48.14-.16.18-.27.27-.45.09-.18.05-.34-.02-.48-.07-.14-.61-1.47-.84-2.01-.22-.53-.45-.46-.61-.47h-.52c-.18 0-.48.07-.73.34-.25.27-.95.93-.95 2.27s.98 2.63 1.11 2.81c.14.18 1.93 2.95 4.68 4.14.65.28 1.16.45 1.55.58.65.21 1.24.18 1.71.11.52-.08 1.59-.65 1.81-1.28.23-.63.23-1.17.16-1.28-.07-.11-.25-.18-.52-.32z"/>
                             <path d="M16.03 3.2c-7.06 0-12.8 5.74-12.8 12.8 0 2.26.59 4.46 1.72 6.4L3.2 28.8l6.55-1.72a12.76 12.76 0 0 0 6.28 1.65h.01c7.06 0 12.8-5.74 12.8-12.8S23.09 3.2 16.03 3.2zm0 23.4h-.01a10.57 10.57 0 0 1-5.39-1.48l-.39-.23-3.89 1.02 1.04-3.79-.25-.4a10.59 10.59 0 1 1 8.89 4.88z"/>
                         </svg>
